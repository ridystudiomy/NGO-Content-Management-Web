 ...
 <div  v-show="donation.img" ><img :src="donation.img" alt=""></div>
      ...
      <div class="card-content">
        ...
        <div class="card-action">
          ...
          <button class="btn pink lighten-4 right"><router-link :to="{ name: 'ViewVproject', params: { id: donation.id }}" class="blue-text" >View More</router-link></button>
          <div class="row left">
...
.transstory .descriptions{
  margin: 30px auto;
}
.transstory .descriptions li{
